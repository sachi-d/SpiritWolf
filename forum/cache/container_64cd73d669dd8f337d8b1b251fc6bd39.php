...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('', 'spiritwo_david', 'Magpie^Nest6835', 'spiritwo_forum', '', false, false);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbhost' => '',
            'dbal.dbuser' => 'spiritwo_david',
            'dbal.dbpasswd' => 'Magpie^Nest6835',
            'dbal.dbname' => 'spiritwo_forum',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
